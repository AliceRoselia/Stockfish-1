...
void MovePicker::score() {
    ...
    for (auto& m : *this)
    {
        ...
        else if constexpr (Type == QUIETS)
        {
            ...
            m.value += (pt == KNIGHT && more_than_one(attacks_bb<KNIGHT>(to)& (pos.pieces(~us,ROOK,KING,QUEEN)))) * 3000;
            m.value += (pt == BISHOP && more_than_one(attacks_bb<BISHOP>(to,pos.pieces())& (pos.pieces(~us,ROOK,KING,QUEEN)))) * 3000;
