...
constexpr int MOVE_PERMUTATION_HISTORY_SIZE = 16384; // Has to be a power of 2.
...
//Move permutation history.
using MovePermutationHistory = Stats<std::int16_t, 10000, COLOR_NB, MOVE_PERMUTATION_HISTORY_SIZE>;
