...
void update_all_stats(const Position& pos,
    ...
    if (!pos.capture_stage(bestMove))
    {
        ...
        for (Move move : quietsSearched)
            update_quiet_histories(pos, ss, workerThread, move, -malus * (33-(quietSearchedNum++))*1291 / 32768);
    }
    else
    {
    ...
    for (Move move : capturesSearched)
    {
        ...
        captureHistory[movedPiece][move.to_sq()][capturedPiece] << -malus * (32 - (captureSearchedNum++)) * 1338 / 32768;
    }
}
