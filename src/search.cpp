...
int stat_bonus(Depth d, bool is_nullmove) { return std::min(168 * d - 100, 1718) + std::min(148 * d - 121, 1742)*is_nullmove; }

// History and stats update malus, based on depth
int stat_malus(Depth d, bool is_nullmove) { return std::min(768 * d - 257, 2351) + std::min(820 * d - 256, 2389)*is_nullmove; }
